...
const blocks = [
  {
    ...
    items: [
      ...
      { time: "09:00", title: "Abertura & Keynote", speaker: "À definir" },
      { time: "10:00", title: "À definir", speaker: "À definir" },
      { time: "11:00", title: "À definir", speaker: "À definir" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "14:30", title: "À definir", speaker: "À definir" },
      { time: "15:30", title: "Painel: O Futuro do PM no Brasil", speaker: "À definir" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "18:00", title: "Fireside Chat", speaker: "À definir" },
